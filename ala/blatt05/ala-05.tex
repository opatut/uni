        ...
        \begin{enumerate}
            ...
            \item[4.]
                ...
                \begin{itemize}
                    ...
                    \item $f''(x) > 0$ für alle $x \in (\infty,1)$        
                \end{itemize}
                Diese Ergebebnisse lassen sich nun folgendermaßen darstellen:
            ...
            \item[5.]
                Aus 4. ergibt sich: \\
                $f$ hat bei x = 1 ein Maximum \\
                $f$ hat bei x = -1 ein Minimum \\ 
                $f$ hat bei x = 0 einen Wendepunkt
